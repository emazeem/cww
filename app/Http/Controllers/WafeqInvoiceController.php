...
//        dd($contact);
        ...
        $response = $client->request('POST', 'https://api.wafeq.com/v1/invoices/', [
            'body' => '{"currency":"SAR","language":"en","status":"DRAFT","line_items":[{"account":"acc_fnBqyLMbShv5VUDeDF83zP","quantity":1,"unit_amount":100,"description":"This provides four car washes in a month"}],"invoice_number":"00001","contact":"co_PxR77dGzHeq6Tx5Aqp5XGe","invoice_date":"2023-12-12"}',
            'headers' => [
                'Authorization' => 'Api-Key ZwVoT8Xa.h6KDRQ937aNNjCAqZBjPd05wjVUCifum',
                'accept' => 'application/json; version=v1',
                'content-type' => 'application/json',
